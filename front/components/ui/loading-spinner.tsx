  ...
  return (
    <div className={`${container} ${className}`.trim()}>
      <div className="flex flex-col items-center gap-3">
        <svg className={`animate-spin ${sizeClass} text-blue-600 dark:text-blue-400`} fill="none" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className={`h-2 ${skeletonWidth} bg-gray-200 rounded animate-pulse`} aria-hidden="true"></div>
